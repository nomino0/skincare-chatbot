    ...
    <div className="relative flex flex-col items-center w-full max-w-md mx-auto">
      ...
      {activeTab === 'webcam' && (
        <>
          ...
          {capturedSnapshot ? (
            // Show captured snapshot with preview
            <div className="w-full mb-4">
              <div className="relative overflow-hidden rounded-xl border-2 border-primary mb-4 w-full">
                <img src={capturedSnapshot} alt="Captured snapshot" className="w-full" />
              ...
              <div className="relative overflow-hidden rounded-xl border-2 border-border mb-4 w-full futuristic-panel">
                ...
                {devices.length > 1 && (
                  <button
                    ...
                    className="absolute top-4 right-4 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all shadow-lg hover:shadow-xl"
                    title={`Switch camera (${devices.findIndex(d => d.deviceId === selectedDeviceId) + 1}/${devices.length})`}
                  >
